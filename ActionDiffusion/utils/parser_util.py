...
def add_data_options(parser):
    ...
    group.add_argument("--dataset",default='graspm3', choices=['humanml', 'kit', 'humanact12', 'uestc', 'graspm3'], type=str,
                       help="Dataset name (choose from list).")
    group.add_argument("--data_dir", default="./diffusion_policy_data_zarr/", type=str,
                       help="If empty, will use defaults according to the specified dataset.")
    group.add_argument("--input_mode",default='seq_params', choices=['seq_params','seq_actions'], type=str,
                       help="the input sequence for the generator network to reconstruct")


def add_training_options(parser):
    group = parser.add_argument_group('training')
    group.add_argument("--save_dir", default='../ActionsDiffusion', type=str,
    ...
    group.add_argument("--eval_batch_size", default=1, type=int,
    ...
    group.add_argument("--num_steps", default=50000, type=int,
                       help="Training will stop after the specified number of steps.")
    group.add_argument("--num_frames", default=40, type=int,
                       help="Limit for the maximal number of frames. In HumanML3D and KIT this field is ignored.")
    group.add_argument("--resume_checkpoint", default="../ActionsDiffusion/model000008000.pt", type=str,
                       help="If not empty, will start from the specified checkpoint (path to model###.pt file).")
    parser.add_argument('--nz', type=int, default=64)
    parser.add_argument('--num_timesteps', type=int, default=1000,
                        help="for the diffusion denoising steps in training")
    parser.add_argument('--sampling_timesteps', type=int, default=100,
                        help="for the diffusion denoising steps in inference")
    parser.add_argument("--lambda_rot_mse", default=5.0, type=float, help="rot_mse loss")
    parser.add_argument("--lambda_trans_mse", default=8.0, type=float, help="rot_mse loss")
    group.add_argument("--lambda_rcxyz", default=13.0, type=float, help="Joint positions loss.")
    group.add_argument("--lambda_vel", default=2.0, type=float, help="Joint velocity loss.")
    group.add_argument("--lambda_fc", default=0.0, type=float, help="Foot contact loss.")
    group.add_argument("--lambda_smooth", default=0.4, type=float, help="Joint motion smooth.")
