...
def retrieve_cfg(args, use_rlg_config=False):
    ...
    elif args.task == "o6HandGraspDexRepIjrr":
        return os.path.join(args.logdir, "o6_hand_grasp_dexrep_ijrr/{}/{}".format(args.algo,args.algo)), "cfg/{}/config.yaml".format(
            args.algo), "cfg/o6_hand_grasp_dexrep_ijrr.yaml"
...
def get_args(benchmark=False, use_rlg_config=False):
    custom_parameters = [
        ...
        {"name": "--task", "type": str, "default": "ShadowHandGraspDexRepIjrr2",
